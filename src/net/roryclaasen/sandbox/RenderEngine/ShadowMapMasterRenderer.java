...
public class ShadowMapMasterRenderer {
	 ...
	 * shader program that are used to render objects to the shadow map, and the {@link ShadowFrameBuffer} to which the scene is rendered. The size of the
	 ...
	 * the "view cuboid" which was also calculated in the {@link ShadowBox} class. These two matrices are multiplied together to create the
