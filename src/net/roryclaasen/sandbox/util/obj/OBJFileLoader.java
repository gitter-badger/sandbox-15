...
public class OBJFileLoader {
	...
	public static ModelData loadOBJ(String file) {
		if (!file.endsWith(".obj")) file += ".obj";
		BufferedReader reader = null;
		try {
			reader = new BufferedReader(Loader.getBufferedStreamReader("assets/models/" + file));
		} catch (NullPointerException e) {
			Log.severe("Could not find model '" + file + "'");
			return null;
		}
		String line;
		...
		try {
			...
			Log.warn("Failed to load model '" + file + "'");
			Log.stackTrace(e);
